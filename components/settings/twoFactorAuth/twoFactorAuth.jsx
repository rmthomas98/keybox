...
export const TwoFactorAuth = ({ twoFactor, currentPhone }) => {
  ...
  useEffect(() => {
    if (phone.length >= 10 && phone.trim() !== currentPhone) {
    ...
    <div className={styles.container}>
      ...
      <Paragraph marginBottom={20}>
        <Small>
          ...
          to your account by requiring more than just a password to log in. When
          2FA is enabled, you will be prompted for a code in addition to your
